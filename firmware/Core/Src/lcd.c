...
#define CS_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS8; } while(0)
#define CS_LOW do { GPIOB->BSRR = GPIO_BSRR_BR8; } while(0)
#define RESET_NUM 11
#define RESET_BIT (1<<RESET_NUM)
#define RESET_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS11; } while(0)
#define RESET_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR11; } while(0)
#define DC_NUM 14
#define DC_BIT (1<<DC_NUM)
#define DC_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS14; } while(0)
#define DC_LOW do { GPIOB->BSRR = GPIO_BSRR_BR14; } while(0)
